...
public class LaundrySRCSVReader extends CSVReader<LaundrySR> {
    private EmployeeDAO employeeDAO = new EmployeeDAO();
        ...
        protected LaundrySR parseAttribute(LaundrySR serviceRequest, String header, String value) {
            switch(header) {
                ...
                case "description":
                    ...
                    break;
                case "laundryType":
                    serviceRequest.setLaundryType(LaundrySR.LaundryType.valueOf(value));
                    break;
                case "quantity":
                    serviceRequest.setQuantity(value);
                    break;
                case "modifierID":
        ...
        @Override
        protected LaundrySR createObject() {
