package edu.wpi.cs3733.D22.teamC.fileio.csv.service_request.delivery_system;
...
public class DeliverySystemSRCSVWriter extends CSVWriter<DeliverySystemSR> {
     ...
     */
    @Override
    protected String compileAttribute(DeliverySystemSR serviceRequest, String header) {
        String output = "";
        switch (header) {
            case "requestID":
