        ...
        public void initializeServiceRequestTable(boolean clearTable) {
            initializeTable(
                    ...
                    "CREATE TABLE SERVICE_REQUEST (" +
                            "ID int NOT NULL GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1), " +
                            "CreatorID int, AssigneeID int, LocationID char(10), " +
...
//                          "CONSTRAINT FK_CreatorID FOREIGN KEY (CreatorID) REFERENCES EMPLOYEE(ID), CONSTRAINT FK_AssigneeID FOREIGN KEY (AssigneeID) REFERENCES EMPLOYEE(ID))",
                    clearTable
            );
        }

        public void initializeEmployeeTable(boolean clearTable){
            initializeTable(
                "EMPLOYEE",
                "CREATE TABLE EMPLOYEE ("+
                        "ID int NOT NULL GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1)," +
                        " FirstName char(16), LastName char(16), Email char(64), Role char(16), IsAdmin boolean, " +
