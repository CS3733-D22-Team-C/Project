...
public class DBManager {
    ...
    //region Table Initialization
        ...
        public void initializeTables(boolean clearTable) {
            ...
            initializeMedicalEquipmentTable(clearTable);
        ...
        public void initializeLocationTable(boolean clearTable) {
            initializeTable(
                    ...
                    "CREATE TABLE LOCATION (" +
                            ...
                            "XCoord int, YCoord int, Floor int, Building char(16), NodeType char(4), " +
                            "LongName char(64), ShortName char(32), CONSTRAINT pk_ID PRIMARY KEY (ID), " +
                            "CONSTRAINT fk_Floor FOREIGN KEY (Floor) REFERENCES FLOOR (ID) ON DELETE CASCADE)",
                    clearTable
            );
        }
        /**
    ...
    public void initializeMedicalEquipmentTable(boolean clearTable) {
        initializeTable(
                "MEDICAL_EQUIPMENT",
                "CREATE TABLE MEDICAL_EQUIPMENT (" +
                        "ID int NOT NULL GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1), locationID int, equipType varchar(50), " +
                        "equipStatus varchar(20), CONSTRAINT pk_equipID PRIMARY KEY (ID), CONSTRAINT fk_locationID FOREIGN KEY (locationID) " +
    ...
    public void initializeFloorTable(boolean clearTable) {
        initializeTable(
                ...
                "CREATE TABLE FLOOR (" +
                        "ID int NOT NULL GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1), " +
                        "FloorOrder int, LongName char(64), ShortName char(32), CONSTRAINT pk_FID PRIMARY KEY (ID))",
                clearTable
        );
    }
    //endregion
