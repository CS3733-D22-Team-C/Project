    ...
    public void initializeMedicalEquipmentTable(boolean clearTable) {
        initializeTable(
                ...
                "CREATE TABLE MEDICAL_EQUIPMENT (" +
                        "ID int NOT NULL GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1), equipType varchar(50), equipStatus varchar(20), CONSTRIANT pk_equipID PRIMARY KEY (ID))",
                clearTable
        );
    }
    //endregion
