...
class MedEqSRDAOImplTest {
    ...
    void testUpdateServiceRequest() {
        ...
        status = ServiceRequest.Status.valueOf("Done");
        priority = ServiceRequest.Priority.valueOf("idk man");
        requestType = ServiceRequest.RequestType.valueOf("Medical Equipment");
